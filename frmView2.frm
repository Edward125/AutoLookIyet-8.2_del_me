...
Dim myval
      myval = SetWindowPos(frmView2.hwnd, -1, 0, 0, 0, 0, 3)
   ...
   II = 0
    ...
    If ViewText2 = "" Then Me.Hide
    LenViewText2 = Len(ViewText2)
    dc = Me.hdc
    ...
    TextOut dc, 0, 0, ViewText2, LenViewText2
